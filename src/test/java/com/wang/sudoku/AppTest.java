...
public class AppTest extends TestCase {
	...
	public void testFillNumber() {
		...
		SudokuResolver app = new SudokuResolver(new int[] { 9, 5, 0, 2, 6, 3, 7, 4, 1, 0, 3, 7, 0, 0, 1, 9, 6, 8, 0, 4,
				1, 7, 8, 9, 5, 2, 3, 1, 0, 0, 0, 9, 0, 3, 0, 0, 5, 0, 0, 1, 3, 2, 0, 0, 4, 0, 0, 3, 0, 7, 0, 0, 1, 5, 3,
				0, 0, 9, 1, 8, 0, 5, 7, 0, 1, 9, 3, 5, 7, 0, 0, 0, 7, 0, 5, 6, 0, 4, 1, 3, 9 });
		app.play();
	}
